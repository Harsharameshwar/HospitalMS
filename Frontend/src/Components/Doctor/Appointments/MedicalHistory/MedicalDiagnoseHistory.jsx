...
export default function MedicalDiagnoseHistory({initial}) {
  ...
  var constime = consdate[1].split('.')

  var appodate = initial.appointmentDate.split('T');
  var appotime = consdate[1].split('.')

  return (
    <>
      <h1 className='text-2xl font-medium text-center mb-3'>Medical History of {initial.name}</h1>
      <h1 className='text-xl text-center font-medium mb-3 mt-3'>Appointment Cause: {appodate[0] + ' ' + appotime[0] }</h1>
        ...
        <div className='flex flex-wrap justify-around'>
          <div>
            ...
            <li>
                ...
                <div className='w-[18rem]'>
                    <p className='text-lg font-small ml-[5%] mb-3 mt-3'>{consdate[0]+" "+ constime[0]}</p>
                </div>
            </li>
